    ...
    return request(app)
      ...
      .then(({ body }) => {
        expect(body).toEqual({
          ...
          "GET /api/articles": {
            description:
              "serves an array of all articles, with optional queries",
          ...
          "PATCH /api/articles/:article_id": {
            description:
              "updates the vote count for the specified article and serves up the updated article",
            queries: [],
            "body?": { inc_votes: 2 },
            exampleResponse: {
              article: {
          ...
          "GET /api/articles/:article_id/comments": {
            description:
              "serves up an array of all comments associated with the article",
            queries: [],
            exampleResponse: {
              comments: [
                {
          ...
          "POST /api/articles/:article_id/comments": {
            description:
              "adds a new comment to an article and serves up the new comment",
            body: { username: "Barney", body: "I'm a big, purple dinosaur" },
            queries: [],
            exampleResponse: {
              comment: {
                body: "Comment text here",
